...
import { USER_REWARDS_COPY } from '../constants/eventZone/userRewards';
...
import { NOTIFICATION_SETTINGS_COPY } from '../constants/mypage/notificationSettings';
...
export const COPY_NAMESPACES = {
  ...
  setup: SETUP_COPY,
  myPage: MY_PAGE_COPY,
  notificationSettings: NOTIFICATION_SETTINGS_COPY,
} as const;
